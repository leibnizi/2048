...
var generateOneNumber = function() {
    ...
    //随机位置
    var randx = parseInt(Math.floor(Math.random() * 12))
    var randy = parseInt(Math.floor(Math.random() * 12))
    // TODO: 优化随机算法
    while (true) {
        if (board[randx][randy] === 0) {
            break;
        }
        randx = parseInt(Math.floor(Math.random() * 12))
        randy = parseInt(Math.floor(Math.random() * 12))
    }
